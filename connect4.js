 ...
 */
 ...
 /** makeHtmlBoard: make HTML table and row of column tops. */
    ...
    finalMessage(){
        const stopGame = document.querySelector("#column-top");
        stopGame.removeEventListener("click", this.handleClickBind);
        alert("Game is over");
    }
...
const game = document.getElementById("game_start");
